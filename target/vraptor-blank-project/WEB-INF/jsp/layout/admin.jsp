<%-- 
    Document   : admin
    Created on : 10/09/2017, 10:54:51
    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li><a href="${linkTo[PainelControleController].index}"><i class="fa fa-dashboard "></i><span>Painel de Controle</span></a></li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="${linkTo[PessoaController].lista}"><i class="fa fa-circle-o"></i>Pessoa</a></li>
                                <li><a href="${linkTo[AtividadeController].cadastro}"><i class="fa fa-circle-o"></i>Atividade</a></li>                                                                
                            </ul>
                        </li>                        
                        <li><a href="http://contribnovo.issprudente.sp.gov.br/Account/Login" target="blank"><i class="fa fa-external-link-square"></i> <span>Nota Fiscal</span></a></li>
                        <li><a href="https://concla.ibge.gov.br/busca-online-cnae.html" target="blank"><i class="fa fa-external-link-square"></i> <span>CNAE</span></a></li>
                        <li class="header">ATIVIDADE</li>
                        <li><a href="${linkTo[ProjetoController].listaAdmin}"><i class="fa fa-building-o"></i> <span>Projeto</span></a></li>
                        <li><a href="${linkTo[LicencaController].listaAdmin}"><i class="fa fa-newspaper-o"></i> <span>Licença</span></a></li>
                        <li><a href="${linkTo[ServicoController].listaAdmin}"><i class="fa fa-wrench"></i> <span>Serviço</span></a></li>
                        <li class="header">FINANCEIRO</li> 
                        <li><a href="${linkTo[OrcamentoController].lista}"><i class="fa fa-pencil-square"></i> <span>Orçamento</span></a></li>
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-check-square-o"></i> <span>Contas à Pagar</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">                                                            
                                <li><a href="${linkTo[ContasPagarController].gerar}"><i class="fa fa-circle-o"></i>Gerar</a></li>  
                                <li><a href="${linkTo[ContasPagarController].lista}"><i class="fa fa-circle-o"></i>Lista de Contas</a></li>
                                <li><a href="${linkTo[ContasPagarController].listaParcelas}"><i class="fa fa-circle-o"></i>Lista de Parcelas do Mês</a></li>
                                <li><a href="${linkTo[ContasPagarController].listaParcelasPagas}"><i class="fa fa-circle-o"></i>Lista de Parcelas Pagas</a></li>
                            </ul>
                        </li>                        
                        <li class="treeview">
                            <a href="#">
                                <i class="fa  fa-briefcase"></i> <span>Contas à Receber</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">   
                                <li><a href="${linkTo[ContasReceberController].gerar}"><i class="fa fa-circle-o"></i>Gerar Conta</a></li>
                                <li><a href="${linkTo[ContasReceberController].lancarRecebimento}"><i class="fa fa-circle-o"></i>Lançar Recebimento</a></li>
                                <li><a href="${linkTo[ContasReceberController].listaContas}"><i class="fa fa-circle-o"></i>Lista de Contas</a></li>                                
                                <li><a href="${linkTo[ContasReceberController].listaParcelasRecebidas}"><i class="fa fa-circle-o"></i>Lista de Contas Recebidas</a></li>                                
                            </ul>
                        </li>
                        <li class="header">ADMINISTRAÇÃO</li> 
                        <li><a href="${linkTo[RelatorioController].index}"><i class="fa fa-print"></i> <span>Relatórios</span></a></li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">   
                                <li><a href="${linkTo[ItemController].lista}"><i class="fa fa-circle-o"></i>Item</a></li>
                                <li><a href="${linkTo[SetorController].lista}"><i class="fa fa-circle-o"></i>Setor</a></li>
                                <li><a href="${linkTo[TipoUsuarioController].lista}"><i class="fa fa-circle-o"></i>Tipo Usuário</a></li>
                                <li><a href="${linkTo[TipoOrcamentoController].lista}"><i class="fa fa-circle-o"></i>Tipo Orçamento</a></li>
                                <li><a href="${linkTo[TipoDespesaController].lista}"><i class="fa fa-circle-o"></i>Tipo Despesa</a></li>
                                <li><a href="${linkTo[ParametroController].lista}"><i class="fa fa-circle-o"></i>Parâmetro</a></li>
                            </ul>
                        </li>

                        <li class="header">AJUDA</li> 
                        <li><a href="${pageContext.request.contextPath}/arquivos/manual/html/Modelo Manual Usuario.html" target="blank"><i class="fa fa-question"></i> <span>Manual do Usuário</span></a></li>
                    </ul>
                </section>
                <!-- /.sidebar -->
            </aside>
        ...
        <script type="text/javascript">
            jQuery(function ($) {
                ...
                $('#preco').mask('9.999.999.999.999.999,99');
            });
        ...
        <script>
            ...
            $(function () {
                CKEDITOR.replace('orcamento.objetivo');
                CKEDITOR.replace('orcamento.proposta');
                CKEDITOR.replace('orcamento.formapagamento');
                CKEDITOR.replace('orcamento.taxaseemolumentos');
                CKEDITOR.replace('orcamento.inicioatividades');
                CKEDITOR.replace('orcamento.validadeproposta');
                $('.textarea').wysihtml5();
            });
        </script>
    </body>
