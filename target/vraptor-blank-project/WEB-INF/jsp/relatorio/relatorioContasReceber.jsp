...
<html>
    <head>
        ...
        <title>Relatório Geoambiental - Contas à Receber</title>
                ...
                <div class="row">
                    <div class="col-xs-12 table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <c:forEach items="${parcelaReceberList}" var="parcela">
                                    <tr>
                                        <td>${parcela.idParcelaReceber}</td>
                                        <td>${l[parcela.valorRecebido].custom("valorMonetario")}</td>
                                        <td>${parcela.dataRecebido.toString("dd/MM/yyyy")}</td> 
                                        <td>${parcela.contasReceber.atividade.pessoa.nome}</td>
                                    </tr>          
                                </c:forEach>
                            </tbody>
                        </table>
