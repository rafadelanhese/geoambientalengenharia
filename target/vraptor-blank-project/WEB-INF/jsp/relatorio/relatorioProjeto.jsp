<%-- 
    ...
    Created on : 24/05/2018, 23:29:32
                            ...
                            <tbody>
                                <c:forEach items="${projetoList}" var="projeto">
                                    <tr>
                                        ...
                                        <td>${projeto.dataFinal.toString("dd/MM/yyyy")}</td>
                                        <td>
                                            <c:choose>
                                        ...
                                        <td>${projeto.setor.descricao}</td>
                                        <td>${projeto.endereco.cidade.nome} - ${projeto.endereco.cidade.estado.sigla}</td>
                                    </tr>          
                                </c:forEach>
                            </tbody>
                        </table>
