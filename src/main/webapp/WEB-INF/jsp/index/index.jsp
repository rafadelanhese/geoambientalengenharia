        ...
        <header class="masthead">
            <div class="container">
                <div class="intro-text">
                    <div> <img src="${pageContext.request.contextPath}/site/img/logos/logoGeoambientalLetrasBrancas.png" alt=""></div>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Mapas temáticos em softwares de informações geográficas em imagens de satélite, levantamento aéreo com VANT e DRONES.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <p class="text-muted">Elaboração de projetos arquitetônicos comerciais, residenciaism clínicas, urbanismo e modelagem 3D</p>
                    </div>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Levantamento planialtimétrico, georreferenciamento de imóveis rurais, desmembramento, retificação de matrículas de imóveis.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <ul class="timeline">
                            <li>
                                <div class="timeline-image">
                                    <img class="rounded-circle img-fluid" src="${pageContext.request.contextPath}/site/img/about/1.jpg" alt="">
                                </div>
                            ...
                            <li class="timeline-inverted">
                                <div class="timeline-image">
                                    <img class="rounded-circle img-fluid" src="${pageContext.request.contextPath}/site/img/about/2.jpg" alt="">
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h4>March 2011</h4>
                            ...
                            <li>
                                <div class="timeline-image">
                                    <img class="rounded-circle img-fluid" src="${pageContext.request.contextPath}/site/img/about/3.jpg" alt="">
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h4>December 2012</h4>
                            ...
                            <li class="timeline-inverted">
                                <div class="timeline-image">
                                    <img class="rounded-circle img-fluid" src="${pageContext.request.contextPath}/site/img/about/4.jpg" alt="">
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h4>July 2014</h4>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="${pageContext.request.contextPath}/site/img/team/1.jpg" alt="">
                            <h4>Kay Garland</h4>
                    ...
                    <div class="col-sm-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="${pageContext.request.contextPath}/site/img/team/2.jpg" alt="">
                            <h4>Larry Parker</h4>
                    ...
                    <div class="col-sm-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="${pageContext.request.contextPath}/site/img/team/3.jpg" alt="">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <a href="#">
                            <img class="img-fluid d-block mx-auto" src="${pageContext.request.contextPath}/site/img/logos/envato.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <a href="#">
                            <img class="img-fluid d-block mx-auto" src="${pageContext.request.contextPath}/site/img/logos/designmodo.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <a href="#">
                            <img class="img-fluid d-block mx-auto" src="${pageContext.request.contextPath}/site/img/logos/themeforest.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <a href="#">
                            <img class="img-fluid d-block mx-auto" src="${pageContext.request.contextPath}/site/img/logos/creative-market.jpg" alt="">
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <form id="contactForm" name="sentMessage" novalidate="novalidate">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" id="phone" type="tel" placeholder="Celular" required="required" data-validation-required-message="Por favor insira seu celular.">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <textarea class="form-control" id="message" placeholder="Digite sua mensagem" required="required" data-validation-required-message="Por favor escreva uma mensagem."></textarea>
                                        <p class="help-block text-danger"></p>
                                    </div>
                                </div>
