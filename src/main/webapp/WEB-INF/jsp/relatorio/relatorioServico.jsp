<%-- 
    Document   : relatorioServico
    Created on : 25/05/2018, 17:50:33
...
<html>
    <head>
        ...
        <title>Relatório Geoambiental - Serviço</title>
                            ...
                            <tbody>
                                <c:forEach items="${servicoList}" var="servico">
                                    <tr>
                                        ...
                                        <td>${servico.dataInicio.toString("dd/MM/yyyy")}</td>
                                        <td>${servico.dataFinal.toString("dd/MM/yyyy")}</td>
                                        <td>
                                            <c:choose>
                                        ...
                                        <td>${servico.endereco.cidade.nome} - ${servico.endereco.cidade.estado.sigla}</td>
                                    </tr>          
                                </c:forEach>
                            </tbody>
                        </table>
